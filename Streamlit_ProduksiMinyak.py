...
table1 = go.Figure(data=[go.Table(header=dict(values=list(df_produksinol.columns), fill_color='#4c837a', align='left'), cells=dict(
    values=df_produksinol.transpose().values.tolist(), fill_color='#7fada6', align='left'))])
...
table2 = go.Figure(data=[go.Table(header=dict(values=list(df_produksikumulatifnol.columns), fill_color='#4c837a', align='left'), cells=dict(
    values=df_produksikumulatifnol.transpose().values.tolist(), fill_color='##7fada6', align='left'))])
